...
export default function WhatWeDoPage() {
    return (
        <main className="min-h-screen bg-[#0d1420] text-white font-sans flex flex-col overflow-x-hidden">
            ...
            {/* Alternating Blocks */}
            <section className="w-full bg-[#2a2e33] py-24">
                <div className="container mx-auto max-w-[1400px] px-6 lg:px-12 space-y-32">
                    
                    {/* Seamless Logistics */}
                    <div className="flex flex-col md:flex-row items-center justify-between gap-12 lg:gap-20">
                        <div className="w-full md:w-5/12 space-y-6">
                            <div className="inline-block bg-[#4cb5e4] text-white text-sm font-semibold px-4 py-1.5 rounded-full">
                                ● Our Delivery
                            </div>
                        ...
                        <div className="w-full md:w-7/12 relative h-[450px] lg:h-[500px]">
                            <Image
                    ...
                    <div className="flex flex-col md:flex-row-reverse items-center justify-between gap-12 lg:gap-20">
                        <div className="w-full md:w-5/12 space-y-6 flex flex-col items-start md:items-end text-left md:text-right">
                            <div className="inline-block bg-[#4cb5e4] text-white text-sm font-semibold px-4 py-1.5 rounded-full">
                                Compliance goal ●
                            </div>
                            <h3 className="text-5xl md:text-6xl font-bold tracking-tight">
                                <span className="text-[#4cb5e4]">Audit</span> Ready
                            </h3>
                            <p className="text-xl text-gray-300 leading-relaxed text-left md:text-right">
                                Compliance isn't a goal, it's our foundation. Ethical sourcing and safety standards ready from day one.
                            </p>
                        </div>
                        <div className="w-full md:w-7/12 relative h-[450px] lg:h-[500px]">
                            <Image
                                src="/images/fabric-rolls.png"
                                alt="Fabric Rolls"
                                fill
                                className="object-cover"
                            />
                    ...
                    <div className="flex flex-col md:flex-row items-center justify-between gap-12 lg:gap-20">
                        ...
                        <div className="w-full md:w-7/12 relative h-[450px] lg:h-[500px]">
                            <Image
                                src="/images/sewing-machines.png"
                                alt="Sewing Machines"
                                fill
                                className="object-cover"
                            />
