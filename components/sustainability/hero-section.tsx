  ...
  return (
    <div className="w-full flex flex-col font-sans">
      ...
      <section className="relative h-[65vh] min-h-[500px] w-full overflow-hidden bg-[#0A1622]">
        ...
        <div className="relative z-10 h-full flex flex-col justify-center items-center text-center px-6 lg:px-12">
          <div className="max-w-5xl mt-12">
            ...
            >
              <span className="block text-4xl md:text-5xl lg:text-7xl font-bold text-white leading-tight tracking-tight mb-5 drop-shadow-md">
                Certified. Transparent. Responsible
              </span>
            </h1>

            <p 
              className={`text-lg md:text-xl text-white/90 max-w-2xl mx-auto font-medium leading-relaxed transition-all duration-1000 delay-300 drop-shadow-sm ${
                isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
              }`}
            >
      ...
      <section className="w-full bg-white relative overflow-hidden flex flex-col lg:flex-row items-center">
        ...
        {/* Left Content */}
        <div className="container mx-auto px-6 lg:px-12 pt-16 pb-10 lg:py-28 relative z-20 lg:w-1/2 flex-shrink-0">
